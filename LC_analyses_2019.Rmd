...
RC <- ggplot () +
  geom_line(data = Comb_Rain, aes(x = Date, y = Carnegie.Rainfall), color = "blue", size = 0.5) + ylim(0,150) + theme(axis.title.x = element_blank())
RP <- ggplot () +
  geom_line(data = Comb_Rain, aes(x = Date, y = Prenti.Rainfall), color = "red", size = 0.5) + ylim(0,150) + theme(axis.title.x = element_blank())
RW <- ggplot () +
  geom_line(data = Comb_Rain, aes(x = Date, y = Wongawol.Rainfall), color = "green", size = 0.5) + ylim(0,150)
